...
namespace AlternativePlay.UI
{
    ...
    public class BeatSaberView : BSMLAutomaticViewController
    {
        ...
        {
            PersistentSingleton<Configuration>.instance.ConfigurationData.LeftSaberTracker = null;
            PersistentSingleton<Configuration>.instance.ConfigurationData.LeftSaberTrackerFullName = null;
            Configuration.instance.SaveConfiguration();
        ...
        {
            PersistentSingleton<Configuration>.instance.ConfigurationData.RightSaberTracker = null;
            PersistentSingleton<Configuration>.instance.ConfigurationData.RightSaberTrackerFullName = null;
            Configuration.instance.SaveConfiguration();
